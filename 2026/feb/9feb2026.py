# https://leetcode.com/problems/balance-a-binary-search-tree/submissions/1914029261
...
# Time complexity: O(n) - We visit each node once to perform the inorder traversal and construct the balanced BST.
# Space complexity: O(n) - The space used to store the inorder traversal and the recursive call stack for constructing the balanced BST.