# https://leetcode.com/problems/minimum-operations-to-equalize-binary-string/submissions/1933186791
...
# Time complexity: O(n^2 / k) in the worst case due to the BFS and the operations on the sorted lists
# Space complexity: O(n) for the distance array and the sorted lists
