# https://leetcode.com/problems/minimum-cost-path-with-teleportations/submissions/1900259987
...
# Time Complexity: O(k * (m * n + m * n log(m * n))) where m and n are the dimensions of the grid.
# Space Complexity: O(m * n) for the costs array and points list.